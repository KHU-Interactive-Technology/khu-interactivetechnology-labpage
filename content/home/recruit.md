...
연구 분야#1: 입출력 장치를 활용한 기발한 인터랙션 기술 및 인터페이스 제작
연구 분야#2: 센서 데이터 수집 및 인공지능 모델 기반의 입력 기술 설계 및 검증
연구 분야#3: 생성형 인공지능 기반 멀티미디어 컨텐츠 생성 
연구 분야#4: 메타물질 기반의 미래 입출력 장치 디자인 및 개발<br>
